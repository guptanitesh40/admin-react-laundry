...
const CouponTable: React.FC<CouponTableProps> = ({ search }) => {
                  ...
                  <tr>
                    <th className="min-w-[100px]">
                      ...
                      >
                        ...
                        <div className="flex cursor-pointer">
                          <FaArrowDownLong
                            color={
                              sortColumn === "coupon_id" && sortOrder === "ASC"
                                ? "gray"
                                : "lightgray"
                            }
                          />
                          <FaArrowUpLong
                            color={
                              sortColumn === "coupon_id" && sortOrder === "DESC"
                                ? "gray"
                                : "lightgray"
                            }
                          />
                    ...
                    <th className="min-w-[150px]">
                      ...
                      >
                        ...
                        <div className="flex cursor-pointer">
                          ...
                          <FaArrowUpLong
                            color={
                              sortColumn === "code" && sortOrder === "DESC"
                                ? "gray"
                                : "lightgray"
                            }
                          />
                    ...
                    <th className="min-w-[150px]">
                      <div
                        className="flex justify-between cursor-pointer"
                        onClick={() =>
                          handleSort("maximum_usage_count_per_user")
                        }
                      >
                        Max Usage/User
                        <div className="flex cursor-pointer mt-2">
